        ...
        <div className="flex gap-4">
            ...
            <div className="flex-grow">
                ...
                {comment.replies && comment.replies.length > 0 && (
                    <div className="mt-4 space-y-4 pl-6 border-l-2 border-gradient-to-b from-purple-200 to-pink-200 relative">
                        <div className="absolute left-0 top-0 w-2 h-full bg-gradient-to-b from-purple-200 to-pink-200 rounded-full"></div>
